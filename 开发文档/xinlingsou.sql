...
MySQL - 5.5.53 : Database - zhongjia
*********************************************************************
*/
...
insert  into `bt_admin`(`id`,`name`,`account`,`passwd`,`pas_salt`,`phone`,`department_id`,`email`,`last_login_time`,`last_login_ip`,`isAdmin`,`status`) values (1,'admin','admin','b4b56071285f36c20bcbedd14b674e85','C3PGHr','13612929081',1,NULL,1514196714,'127.0.0.1',1,10),(2,'cs','cs','b4b56071285f36c20bcbedd14b674e85','C3PGHr','13612929081',2,NULL,NULL,NULL,0,10);
...
insert  into `bt_role`(`id`,`name`,`sort`,`status`) values (2,'管理员',20,5),(3,'员工',25,5);
